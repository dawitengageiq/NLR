...
class SendLeadsUnitTest extends TestCase
{
     ...
     * constructor
     */
    public function __construct(){$this->getLeadsForValidator();}
    /**
     * @test
    ...
    public function capreach_should_return_true_if_campaign_counts_and_campaign_affiliate_counts_were_both_not_null_and_return_false_if_campaign_counts_and_campaign_affiliate_counts_were_both_null()
    {
    	...
    	$campaign = $this->getMockBuilder(CampaignRepository::class)
    				->setMethods(array('getCampaignByIdAndStatus'))
    				->getMock();
        ...
        $affiliate = $this->getMockBuilder(AffiliateRepository::class)
        			->setMethods(array('getAffiliateById'))
        			->getMock();
    	...
    	$capReached = $this->getMockBuilder(LeadTestController::class)
    					...
    					->setMethods(array('checkCapNoReset'))
    					->getMock();
