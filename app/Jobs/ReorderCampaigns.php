    ...
    public function handle(Settings $setting)
    {
        ...
        if($globalOrderStatus==1)
        {
            ...
            foreach($reports as $report)
            {
                ...
                else if($revenueTrackerViews<=0 && $globalViews<=0)
                {
                ...
                if($revenueTrackerViews>0 && $revenueTrackerOrderStatus==1)
                {
                    ...
                    if($report->views>=$revenueTrackerViews)
                    {
                        ...
                        foreach($leads as $lead) {
                            ...
                            {
                                $lead_report[$report->revenue_tracker_id][$lead->campaign_id]['revView'] = doubleval($lead->revenue) / doubleval($report->views);
                            }
                        }
