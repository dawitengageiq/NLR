...
trait Margin
{
    ...
    {
        if(!array_key_exists('source_revenue', $this->revenues)) $this->revenues['source_revenue'] = 0;
        if(!array_key_exists('payout', $this->revenues)) $this->revenues['payout'] = 0;

        if(($this->revenues['source_revenue'] == 0 )) return;
