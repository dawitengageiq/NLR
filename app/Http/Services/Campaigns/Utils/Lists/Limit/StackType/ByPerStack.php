...
final class ByPerStack implements \App\Http\Services\Campaigns\Utils\Lists\Contracts\LimitContract
{
    ...
    public function set ($globalLimitPerStack)
    {
        ...
        if($globalLimitPerStack) $this->globalLimitPerStack = $globalLimitPerStack;
    }
    ...
    {
        if($this->globalLimitPerStack != null) return false;

        if($stackCount < $this->globalLimitPerStack) return false;
        return true;
    }
}
