...
class RevenueTracker
{
    ...
    public function get($userDetails)
    {
        ...
        if(!$userDetails) $this->defaultRevenueTracker();
    ...
    public function setDetails ($details)
    {
        ...
        if(array_key_exists('revenue_tracker_id', $details)) $this->revenueTrackerID = $details['revenue_tracker_id'];
    }
    ...
    public function orderType ()
    {
        ...
        if(array_key_exists($this->orderType, $orderType)) return $orderType[$this->orderType];
