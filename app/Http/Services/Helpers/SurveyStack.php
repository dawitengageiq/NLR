...
class SurveyStack
{
    ...
    {
        if($removeTrailingSlash) return preg_replace('{/$}', '', $this->targetUrl);
    ...
    {
        if ($this->targetUrl(true) == 'http://leadreactor.engageiq.com') return 'http://path2.paidforresearch.com/assets/js/api/iframe-content.min.js?t' . time();
