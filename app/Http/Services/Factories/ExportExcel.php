...
abstract class ExportExcel extends \Maatwebsite\Excel\Excel
{
     ...
     *
     * @var LaravelExcelWriter $createdFile;
     */
    public function generate ()
    {

        $this->createdFile = $this->create($this->fileName, function($excel) {
            $this->excel = $excel;
    ...
    {
        if(!$this->createdFile instanceof \Maatwebsite\Excel\Writers\LaravelExcelWriter) return;
